...
// Forzado de Base de Datos (Ya funcionó)
    ...
    System.setProperty("spring.mail.username", "tu_correo@gmail.com"); // Pon tu correo real aquí
    System.setProperty("spring.mail.password", "tu_token_de_16_letras"); // Pon tu token real aquí
